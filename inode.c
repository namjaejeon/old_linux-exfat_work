...
struct exfat_dentry *get_dentry_in_dir(struct super_block *sb, struct exfat_chain *p_dir, int entry,
...
static int __count_dos_name_entries(struct super_block *sb, struct exfat_chain *p_dir,
