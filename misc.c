...
static inline void __write_bhs(struct buffer_head **bhs, int nr_bhs)
{
	int i;
...
static inline int __sync_bhs(struct buffer_head **bhs, int nr_bhs)
{
	int i, err = 0;
...
static inline int __buffer_zeroed(struct super_block *sb,
		...
		unsigned long long num_secs)
{
	...
	if (((sec+num_secs) > sbi->num_sectors) && (sbi->num_sectors > 0)) {
